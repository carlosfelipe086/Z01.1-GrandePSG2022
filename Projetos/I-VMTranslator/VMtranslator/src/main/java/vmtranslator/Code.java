...
public class Code {
    ...
    public void writeArithmetic(String command) {
        ...
        if(command.equals("add")) {
            ...
            commands.add("leaw $0, %A");    //Carrega sp em A
            commands.add("movw (%A), %A");  //Pega o valor do Sp e salva em A
            commands.add("decw %A");        //Reduz o sp salvo em 1
            commands.add("negw (%A)");      //Realiza operacao de neg em (%A)


        } else if (command.equals("eq")) {
            commands.add(String.format("; %d - EQ", lineCode++));
            commands.add("leaw $0, %A");        //Carrega Sp em A
            commands.add("movw (%A), %A");      //Valor de Sp em A
            commands.add("decw %A");            //Decresce sp em A
            commands.add("movw (%A), %D");      //Move o valor da ultima ram para D
            commands.add("decw %A");            //Decresce A
            commands.add("subw (%A), %D, %D");  //Subtrai (%A) %D, salva em %D

            commands.add("leaw $ZERO" + lineCode + ", %A");      //Carrega salto ZERO
            commands.add("je, %D");              //Jump caso zero
            commands.add("nop");                 //Carrega nop

            commands.add("leaw $0, %A");        //Carrega FALSE em %A
            commands.add("movw, %A, %D");       //Move para %D
            commands.add("movw (%A), %A");      //Pega o valor do SP
            commands.add("decw %A");            //Decresce sp em A
            commands.add("decw %A");            //Decresce sp em A
            commands.add("movw, %D, (%A)");     //Move para %A

            commands.add("leaw $END" + lineCode +", %A");      //Carrega salto END
            commands.add("jmp");                //Jump
            commands.add("nop");                //Carrega nop

            commands.add(String.format("ZERO" + lineCode + ":"));
            commands.add("movw $-1, %A");       //Carrega TRUE em %A
            commands.add("movw, %A, %D");       //Move para %D
            commands.add("leaw $0, %A");        //Carrega Sp em A
            commands.add("movw (%A), %A");      //Pega o valor de SP
            commands.add("decw %A");            //Decresce sp em A
            commands.add("decw %A");            //Decresce sp em A
            commands.add("movw, %D, (%A)");     //Move para %D

            commands.add(String.format("END" + lineCode + ":"));
            commands.add("leaw $0, %A");        //Carrega SP em %A
            commands.add("movw (%A), %A");      //Pega o valor de SP
            commands.add("decw %A");            //Decresce sp em A
            commands.add("movw %A, %D");
            ...
            commands.add("leaw $MAIOR" + lineCode + ", %A");      //Carrega salto ZERO
            commands.add("jg, %D");              //Jump caso zero
            commands.add("nop");                 //Carrega nop
            ...
            commands.add(String.format("MAIOR" + lineCode + ":"));
            commands.add("movw $-1, %A");       //Carrega TRUE em %A
            commands.add("movw, %A, %D");       //Move para %D
            commands.add("leaw $0, %A");        //Carrega Sp em A
            commands.add("movw (%A), %A");      //Pega o valor de SP
            ...
            commands.add("leaw $ZERO" + lineCode + ", %A");      //Carrega salto ZERO
            commands.add("jl, %D");              //Jump caso zero
            commands.add("nop");                 //Carrega nop
