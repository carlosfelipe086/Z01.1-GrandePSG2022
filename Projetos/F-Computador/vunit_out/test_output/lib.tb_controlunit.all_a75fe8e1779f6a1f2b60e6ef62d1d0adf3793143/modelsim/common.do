...
proc is_test_suite_done {} {
    set fd [open "/home/borg/Desktop/Psg3/Z01.1-GrandePSG2022/Projetos/F-Computador/vunit_out/test_output/lib.tb_controlunit.all_a75fe8e1779f6a1f2b60e6ef62d1d0adf3793143/vunit_results" "r"]
...
proc vunit_compile {} {
    set cmd_show {/usr/bin/python3 -u ./testeHW.py --compile lib.tb_controlunit.all}
    puts "Re-compiling using command ${cmd_show}"

    set chan [open |[list {/usr/bin/python3} {-u} {-c} {import sys;import subprocess;exit(subprocess.call(['/usr/bin/python3', '-u', './testeHW.py', '--compile', 'lib.tb_controlunit.all'], cwd='/home/borg/Desktop/Psg3/Z01.1-GrandePSG2022/Projetos/F-Computador', bufsize=0, universal_newlines=True, stdout=sys.stdout, stderr=sys.stdout))}] r]
